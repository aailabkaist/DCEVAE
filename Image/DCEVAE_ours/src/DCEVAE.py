...
class DCEVAE(nn.Module):
    ...
    def q_u(self, x, a):
        ...
        :param x: input image
        :param a: input intervention
        :return: parameters of q(u|x), (MB, hid_dim)
        """
    ...
    def p_x(self, u, a):
        ...
        :param u: latent vector          (MB, hid_dim)
        :param a: input intervention     (MB, a_dim)
        :return: parametersc of p(x|a,u) and p(x_cf|a,u)    (MB, inp_dim)
        """
    ...
    def calculate_loss(self, x, sens, rest, des, x2, sens2, beta1=1, beta2=1, beta3=1, beta4=1):
        """
        Given the input batch, compute the Loss of DCEVAE
        :param x, sens, rest, des, x2, sens2
        :param beta's: Float
        :return: Loss
        """
