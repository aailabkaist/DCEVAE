...
parser.add_argument('--a_f', type=float, default=1, help='hyper-parameter for fairness')
...
def main(args):
    ...
    print(input_dim)
    model = CSVAE(r_dim=input_dim['r'], d_dim=input_dim['d'], sens_dim=input_dim['a'], label_dim=input_dim['y'], args=args).to(args.device)
